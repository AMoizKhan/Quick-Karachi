...
const pages = [
  ...
  { label: "Contact Now", href: "/contact-us" },
];
...
export default function Footer() {
  ...
  <p className="text-sm text-gray-500 text-center md:flex-1">
    &copy; {new Date().getFullYear()} Quick Karachi Transportation Service.
    All rights reserved.
  </p>
