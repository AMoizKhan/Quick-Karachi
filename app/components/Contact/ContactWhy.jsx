      ...
      <div className="flex flex-col lg:flex-row gap-4">
        {reasons.map(({ text, icon: Icon }) => (
          <div
            key={text}
            data-reveal-card
            className="group flex-1 flex flex-col items-center text-center gap-4 p-6 bg-white rounded-xl border border-gray-100 shadow-sm hover:bg-red-600 hover:shadow-md transition-all duration-300"
          >
            {/* Icon circle */}
            ...
            <p className="flex-1 text-sm lg:text-base text-gray-700 leading-6 transition-colors duration-300 group-hover:text-white break-words">
              {text}
            </p>
          </div>
        ))}
