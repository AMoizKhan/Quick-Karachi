    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {contactItems.map((item) => {
        ...
        const content = (
          <div
            data-reveal-card
            className="group flex items-start gap-4 p-6 bg-white rounded-xl border border-gray-200 shadow-sm h-full hover:bg-red-600 active:bg-red-600 transition-colors duration-300"
          >
            <div className="w-12 h-12 rounded-full bg-[#fd0014]/10 flex items-center justify-center shrink-0 transition-colors duration-300 group-hover:bg-white group-active:bg-white group-[.in-view]:bg-white">
