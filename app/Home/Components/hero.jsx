...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-3xl">
          <h1 className="text-white font-bold leading-tight">
            ...
            <span className="block text-3xl sm:text-5xl lg:text-7xl text-red-500 min-h-[1.2em]">
              {text}
              <span className="animate-pulse">|</span>
            </span>
          ...
          <p className="text-white text-sm sm:text-base lg:text-lg max-w-2xl leading-relaxed mt-6 sm:mt-8">
            Quick Karachi Transportation Service (QKTS) is a Karachi-based ride
            service created to make daily travel safer, more affordable, and
            more reliable for students, professionals, and families. Built on
            real commuter problems in Karachi, QKTS focuses on verified drivers,
            fair pricing, and customer-first service, with booking available
            through WhatsApp and social media.
          </p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center mt-8 gap-3 bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded transition-all duration-300"
          >
            <Image
              src="/images/whatsapp.svg"
              alt="WhatsApp"
